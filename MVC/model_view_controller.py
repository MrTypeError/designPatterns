...
class ModelBasic(object):
    ...
    def create_item(self, name, price, quantity):
        basicBackend.create_item(name, price, quantity)

    def create_items(self, items):
        basicBackend.create_items(items)

    def read_item(self, name):
        return basicBackend.read_item(name)

    def read_items(self):
        return basicBackend.read_items()

    def update_item(self, name, price, quantity):
        basicBackend.update_item(name, price, quantity)

    def delete_item(self, name):
        basicBackend.delete_item(name)
